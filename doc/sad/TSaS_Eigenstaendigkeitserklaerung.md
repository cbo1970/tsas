...
KI-Werkzeuge — insbesondere Claude Code (Modelle Opus 4.7 / 4.8 als Hauptmodell, Sonnet 4.6 für Subagents) sowie die zugehörige Superpowers-Skill- und Subagent-Infrastruktur (siehe SAD Kapitel 13) — wurden systematisch für Spezifikation, Planung, Implementierung, Review und Recherche eingesetzt. Jeder KI-Vorschlag wurde vor Übernahme manuell geprüft. Bewusst nicht delegierte Entscheidungen (Security-Konfiguration, Architekturentscheidungen, Domänenregeln) sind in SAD Kapitel 14 (Reflexion und Fazit) mit Begründung und Beleg ausgewiesen.
